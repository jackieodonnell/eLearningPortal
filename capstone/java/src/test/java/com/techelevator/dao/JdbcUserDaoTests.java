...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1", "ROLE_USER", "firstName1", "lastName1");
    protected static final User USER_2 = new User(2, "user2", "user2", "ROLE_USER", "firstName2", "lastName2");
    private static final User USER_3 = new User(3, "user3", "user3", "ROLE_USER", "firstName3", "lastName3");
    ...
    public void create_user_with_null_username() {
        sut.create(null, USER_3.getPassword(), "ROLE_USER", "firstName3", "lastName3");
    }

    @Test(expected = DataIntegrityViolationException.class)
    public void create_user_with_existing_username() {
        sut.create(USER_1.getUsername(), USER_3.getPassword(), "ROLE_USER", "firstName1", "lastName1");
    }

    @Test(expected = IllegalArgumentException.class)
    public void create_user_with_null_password() {
        sut.create(USER_3.getUsername(), null, "ROLE_USER", "firstName3", "lastName3");
    }

    @Test
    public void create_user_creates_a_user() {
        User newUser = new User(-1, "new", "user", "ROLE_USER", "newFirstName", "newLastName");

        boolean userWasCreated = sut.create(newUser.getUsername(), newUser.getPassword(), "ROLE_USER", newUser.getFirstname(), newUser.getLastname());
